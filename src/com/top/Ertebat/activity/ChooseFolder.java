...
public class ChooseFolder extends ErtebatListActivity {
    public static final String EXTRA_ACCOUNT = "com.top.Ertebat.ChooseFolder_account";
    public static final String EXTRA_CUR_FOLDER = "com.top.Ertebat.ChooseFolder_curfolder";
    public static final String EXTRA_SEL_FOLDER = "com.top.Ertebat.ChooseFolder_selfolder";
    public static final String EXTRA_NEW_FOLDER = "com.top.Ertebat.ChooseFolder_newfolder";
    public static final String EXTRA_MESSAGE = "com.top.Ertebat.ChooseFolder_message";
    public static final String EXTRA_SHOW_CURRENT = "com.top.Ertebat.ChooseFolder_showcurrent";
    public static final String EXTRA_SHOW_FOLDER_NONE = "com.top.Ertebat.ChooseFolder_showOptionNone";
    public static final String EXTRA_SHOW_DISPLAYABLE_ONLY = "com.top.Ertebat.ChooseFolder_showDisplayableOnly";
