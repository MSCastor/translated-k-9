...
public class AccountSetupBasics extends ErtebatActivity
    ...
    private final static String EXTRA_ACCOUNT = "com.top.Ertebat.AccountSetupBasics.account";
    private final static int DIALOG_NOTE = 1;
    private final static String STATE_KEY_PROVIDER =
            "com.top.Ertebat.AccountSetupBasics.provider";
    private final static String STATE_KEY_CHECKED_INCOMING =
            "com.top.Ertebat.AccountSetupBasics.checkedIncoming";
