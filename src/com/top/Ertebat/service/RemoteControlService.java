...
import com.top.Ertebat.remotecontrol.ErtebatRemoteControl;
import com.top.Ertebat.Preferences;
import com.top.Ertebat.R;
import com.top.Ertebat.Account.FolderMode;
import com.top.Ertebat.Ertebat.BACKGROUND_OPS;

import static com.top.Ertebat.remotecontrol.ErtebatRemoteControl.*;
...
public class RemoteControlService extends CoreService {
    private final static String RESCHEDULE_ACTION = "com.top.Ertebat.service.RemoteControlService.RESCHEDULE_ACTION";
    private final static String PUSH_RESTART_ACTION = "com.top.Ertebat.service.RemoteControlService.PUSH_RESTART_ACTION";

    private final static String SET_ACTION = "com.top.Ertebat.service.RemoteControlService.SET_ACTION";
            ...
            execute(getApplication(), new Runnable() {
                public void run() {
                    try {
                        ...
                        if (needsReschedule) {
                            Intent i = new Intent();
                            i.setClassName(getApplication().getPackageName(), "com.top.Ertebat.service.RemoteControlService");
