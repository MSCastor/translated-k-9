...
import com.top.Ertebat.activity.MessageCompose;
import com.top.Ertebat.activity.UpgradeDatabases;
...
import com.top.Ertebat.provider.UnreadWidgetProvider;
import com.top.Ertebat.security.LocalKeyStore;
import com.top.Ertebat.service.BootReceiver;
import com.top.Ertebat.service.MailService;
import com.top.Ertebat.service.ShutdownReceiver;
import com.top.Ertebat.service.StorageGoneReceiver;
...
public class Ertebat extends Application {
     ...
     * was called.
     * Afterwards calls to {@link #registerApplicationAware(com.top.Ertebat.Ertebat.ApplicationAware)} will
     * immediately call {@link com.top.Ertebat.Ertebat.ApplicationAware#initializeComponent(Ertebat)} for the
     * supplied argument.
     */
    ...
    public static class Intents {
        ...
        public static class EmailReceived {
            public static final String ACTION_EMAIL_RECEIVED    = "com.top.Ertebat.intent.action.EMAIL_RECEIVED";
            public static final String ACTION_EMAIL_DELETED     = "com.top.Ertebat.intent.action.EMAIL_DELETED";
            public static final String ACTION_REFRESH_OBSERVER  = "com.top.Ertebat.intent.action.REFRESH_OBSERVER";
            public static final String EXTRA_ACCOUNT            = "com.top.Ertebat.intent.extra.ACCOUNT";
            public static final String EXTRA_FOLDER             = "com.top.Ertebat.intent.extra.FOLDER";
            public static final String EXTRA_SENT_DATE          = "com.top.Ertebat.intent.extra.SENT_DATE";
            public static final String EXTRA_FROM               = "com.top.Ertebat.intent.extra.FROM";
            public static final String EXTRA_TO                 = "com.top.Ertebat.intent.extra.TO";
            public static final String EXTRA_CC                 = "com.top.Ertebat.intent.extra.CC";
            public static final String EXTRA_BCC                = "com.top.Ertebat.intent.extra.BCC";
            public static final String EXTRA_SUBJECT            = "com.top.Ertebat.intent.extra.SUBJECT";
            public static final String EXTRA_FROM_SELF          = "com.top.Ertebat.intent.extra.FROM_SELF";
        }

        public static class Share {
            /*
             * We don't want to use EmailReceived.EXTRA_FROM ("com.top.Ertebat.intent.extra.FROM")
             * because of different semantics (String array vs. string with comma separated
             * email addresses)
             */
            public static final String EXTRA_FROM               = "com.top.Ertebat.intent.extra.SENDER";
        }
    }
