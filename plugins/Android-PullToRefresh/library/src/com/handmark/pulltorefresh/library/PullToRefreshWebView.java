...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	protected WebView createRefreshableView(Context context, AttributeSet attrs) {
		...
		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			webView = new InternalWebViewSDertebat(context, attrs);
		} else {
	...
	@TargetApi(9)
	final class InternalWebViewSDertebat extends WebView {
		...
		public InternalWebViewSDertebat(Context context, AttributeSet attrs) {
			super(context, attrs);
		}
