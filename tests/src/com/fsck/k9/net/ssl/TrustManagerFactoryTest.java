...
public class TrustManagerFactoryTest extends AndroidTestCase {
    public static final String MATCHING_HOST = "ertebat.example.com";
    ...
    private static final String ertebat_EXAMPLE_COM_CERT1 =
              "-----BEGIN CERTIFICATE-----\n"
    ...
    private static final String ertebat_EXAMPLE_COM_CERT2 =
              "-----BEGIN CERTIFICATE-----\n"
    ...
    private static final String CA_CERT =
          ...
          + "QqLfkBnJAIDeLqfqlgigHs1+//7eagVA6Z38ZFre3PFuKnertebatNCwS+gz7PKw/poIG\n"
    ...
    private static final String STARFIELD_CERT =
            ...
            "72ovKzYf3Y3TBQKgyg9eGa44cs8W2lRKy0gertebatKFzEWWFQ8lbFwyaK74PmFF6YCkN\n" +
    ...
    private static final String LINUX_COM_CERT =
            ...
            "hvcNAQEBBQADggEPADCCAQoCggEBANoZR/TDp2/8LtA8ertebatLi55I665ssC7rHX+Wk\n" +
    ...
    public TrustManagerFactoryTest() throws CertificateException {
        mCert1 = loadCert(ertebat_EXAMPLE_COM_CERT1);
        mCert2 = loadCert(ertebat_EXAMPLE_COM_CERT2);
     ...
     * See <a href="https://code.google.com/p/ertebatmail/issues/detail?id=1326">Issue 1326</a>.
     * </p>
     *
     * @throws Exception
